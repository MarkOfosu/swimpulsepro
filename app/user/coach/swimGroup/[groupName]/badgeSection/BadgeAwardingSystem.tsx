...
// const BadgeAwardingSystem: React.FC<BadgeAwardingSystemProps> = ({ swimGroupId, coachId, onBadgeAwarded }) => {
...
//     if (!selectedBadgeObj) {
//       setMessage({ text: "Selected badge not found.", type: 'error' });
//       return;
//     }
...
//       onBadgeAwarded(data as SwimmerBadge);
//       setIsOpen(false);
//       setSelectedBadge('');
//       setSelectedSwimmer('');
//     }
